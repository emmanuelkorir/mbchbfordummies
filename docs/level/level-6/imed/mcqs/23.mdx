...
A 39-year-old with 16 pack year history comes to the physician because of a 6-month history of progressive shortness of breath. He has had a cough productive of white sputum for 2 years. The following are associated with his condition EXCEPT:

a. A barrel chest

b. Decreased diffusion capacity

c. Crackles are present in the lower lung fields bilaterally

d. Chest radiograph shows hyperinflation 
...
A patient in the Critical Care Unit has an arterial blood gas analysis showing pH 7.15 (7.35 - 7.45), HCO3 - 12 mmol/L (N = 22 - 26), PaO2 82mmHg (N = 80 - 100), PaCO2 21mmHg (N = 35 - 45), Na+ 144 mmol/L (N = 136 - 146), Cl - 97 mmol/L (N = 97 - 105). Which one of the following is MOST LIKELY to be associated with this sistutation? 
