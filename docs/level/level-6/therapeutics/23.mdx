...
- Ginko biloba - intermittent claudication, cerebral insufficiency and alzheimer’s, antioxidant. Causes anxiety as a side effect
</details>
...
Others: probenecid & penicillin. Probenecid inhibits active tubular secretion of penicillin.
</details>
...
<details>
c. Zileuton- 5- lipoxygenase inhibitor that is used in long term treatment of asthma
</details>

### Question 34

One of the following drugs used in  management of bleeding works via  inhibition of activation of plasminogen 
...
Ethamsylate - inhibit platelet adhesiveness, increases capillary endothelial resistance
</details>
...
<details>
c. Zidovudine - all NRTIs can cause mitochondrial toxicity. Other side effects of zidovudine: bone marrow suppression, anemia, leukopenia, lipodystrophy
</details>
...
Which drug should be avoided in  myoclonic seizures 
...
<details>
c. Phenytoin - exacerbate the seizures. Avoid phenytoin & carbamazepine in myoclonic & petit mal(absence)
</details>

### Question 38

A 58-year-old business executive is  brought to the emergency department 2h after the onset of severe chest pain  during a vigorous tennis game. She has a history of poorly controlled mild hypertension and elevated blood cholesterol but does not smoke. ECG changes confirm the diagnosis of myocardial infarction. The decision is  made to attempt to open her occluded artery. Which of the following drugs accelerates the conversion of plasminogen to plasmin? 
...
Which antidote works by chemical  antagonism of the drug indicated: - 
...
Which anti-tuberculous drug is  nephrotoxic, hepatotoxic & causes  hyperuricemia: - 
...
Most hepatotoxic to least: Pyrazinamide, isoniazid, rifampicin, rifapentine. Rifabutin is safe in hepatic dx

- Ethambutol - optic neuritis (red-green color blindness)
- Rifapentine(long acting + rifabutin) - hepatotoxicity. Similar to rifampicin(short acting). Rifabutin & streptomycin safe in hepatic dx, require no dose adjustment
- Pyrazinamide dose adjusted in CKD (CrCL is less than 30ml/min). Similar to streptomycin(nephrotoxic). 
- Ethambutol, rifampicin, rifabutin & rifapentine require no dose adjustment in CKD.
</details>

### Question 41

Identify the anti-hepatitis B drug with  the highest barrier to resistance 
...
- High barrier - tenofovir, entecavir
- Low - lamivudine, emtricitabine, telbivudine
</details>

### Question 42

The following have uricosuric effects  except: - 
...
The following are indicated for the  treatment of multiple sclerosis except 
...
<details>
c. Among the sulfonylureas gliclazide has  the lowest risk of hypoglycemia in  patients with impaired kidney function.
- Glipizide & glimepiride used in CKD. Initiated slowly to avoid hypoglycemia. Avoid <strong>glyburide</strong>
- Metformin contraindications:
<ul>
    <li>Hepatic dx - lactic acidosis(liver cannot metabolize lactic acid)</li>
    <li>Renal impairment</li>
    <li>CCF</li>
    <li>Chronic hypoxic lung dx</li>
    <li>Alcoholism</li>
    <li>Past hx of lactic acidosis</li>
</ul>
- For atherosclerotic CVD, HF, kidney dx, add SGLT-2 (-flozins) & GLP-1 agonists(-glutides): dulaglutide(sc), liraglutide(sc), semaglutide (sc or oral). Metformin has potential benefit in ASCVD.
- oral hypoglycemic agents (OHA) ineffective in type I (except alpha glucosidase). 
- OHA causing hypoglycemia: sulfonylureas, non-sulfonylureas(repaglinide, nateglinide, mitiglinide)
- weight loss drugs: SGLT-2(upto 5kg), metformin in some
- weight gain drugs: sulfonylureas, thiazolidinediones(-glitazones). 
</details>
...
Which gene delivery vehicle has a  large packaging capacity & persistent  gene transfer when used for gene  therapy:  
...
<details>
d. Herpes simplex virus (HSV) -1. 40-150kb. AEs: residual cytotoxicity with neurons.

- Human foamy virus - 8.5kb. Persistent gene expression in both dividing & non-dividing cells.
- Retroviral - 8kb. Persistent gene trasnfer in diving cells. 
- Lentivirus - 8kb. Persistent gene transfer in transduced tissues. 
- Adeno-associated virus - 5kb. Elicits few inflammatory response, nonpathogenic
- alpha virus - 5kb. Limited immune respnse. 

</details>

### Question 48

When using parenteral nutrition,  complications of overfeeding include the  following except 
...
- CHO more than 5mg/kg/min. Increased CO2 production, increased minute ventilation leading to respiratory failure & prolonged mechanical ventilation. Also hyperinsulinemia. K+, Phosphate intracellular
- More than 150% total energy expenditure - fatty liver. Increased SGOT, SGPT, ALP, hepatomegaly, cholestasis
- More than 2g/kg/d fat. Congestion of RES. Hypertriglyceridemia
- More than 2g/kg/d protein. Ureagenesis
- WBC - impaired phagocytosis. Impaired neutrophil chemotaxis
</details>

### Question 49

Which of the following prostaglandin  analogue is used in the management of  postpartum hemorrhage?
...
- Misoprostol - induction or termination
- Gemeprost - termination of labor
- Alprostadil - PDA,ED
- Latanoprost - open angle glaucoma
- Epoprostadil - primary pulmonary HTN
- Dinoprostone - induction of labor 

- Termination of pregnancy: gemeprost, misoprostol (GM)
- Induction of labor: dinoprostone, misoprostol (DM)
- Ulcer prophylaxis in NSAIDs: misoprostol
- Maintenance of PDA patency: alprostadil

</details>

### Question 50

Which drug is well adsorbed by  activated charcoal? 
...
<details>
b. Phenobarbital. Others: carbamazepine, salicylates, PCM
</details>
