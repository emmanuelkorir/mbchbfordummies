...
a.
Initiate spironolactone 25 mg OD

b.
Initiate atenolol

c.
No further action is necessary as his BP control is adequate

d.
Initiate methyldopa

e.
Increase the hydrochlorothiazide to 50 mg OD
...
c.
Diffuse large 8-Cell lymphoma (DLBCL)
...
a.
lmmunosuppression should be suspected

b.
Recurrent sexually transmitted infections is a risk factor

c.
Radiologic imaging of the urinary tract is indicated

d.
Neurogenic bladder is associated

e.
Nocturnal enuresis is a risk factor
A 59-year-old male, who is a known smoker, is brought to the Accident and Emergency (A & E) in a confused state. Blood analysis shows:- Serum Creatinine 109 umol/L (N = 85 - 105), Urea 7.2mmol/L (N = 3.5 - 6.5), K+ 3.72mmol/L (N = 3.5 - 5.4), Na+ 118mmol/L (N = 135 - 144). Which one of the following is an UNLIKELY FINDING?
Question 39Answer
